...
# chrome.open_new(filename)

# webbrowser.open_new(filename)
# bash_comm1 = "su mk" 
bash_comm2 = "firefox " + filename

# os.system(bash_comm1)
os.system(bash_comm2)

# os.system("su mk")
# os.system("sensible-browser " + filename)

# execute = os.system('echo %s|sudo -S %s' % ("k@13913", "firefox " + filename))
